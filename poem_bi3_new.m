...
function [ph_cmb,mag_cmb,offset_real, offset_imaginary] = poem_bi3_new(mag, pha, vox, te, mask, smooth_method, parpool_flag)
...
[ph_cmb,mag_cmb, offset_real, offset_imaginary] = poem_new(mag, pha, vox, te, mask);
